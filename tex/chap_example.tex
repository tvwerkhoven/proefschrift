...
% Command specific for this chapter (could also go in main tex file)
...
The sun has a mass of $M_\odot=(1.9889\pm0.0003)\times10^{30}$~kg or better $M_\odot=$ \SI[multi-part-units = brackets]{1.9889\pm\pm0.0003e30}{\kilogram} and a luminosity of $L_\odot=(3.844\pm0.010)\times10^{26}$~W\@.
...
\newcommand{\tabval}[3]{#1.&#2 & ± #3}
\newcommand{\tabvalb}[4]{#1.&#2&\makebox[0pt][l]{\tsub{\minus #3}}\tsup{+#4}}
